...
/**
 * Theme ported from the CogniCore aura.build template — the exact dark-zinc
 * palette, blue primary, glow shadows and gradients — extended with the
 * threat-severity colors Argus needs (red/amber/emerald).
 */
const config: Config = {
  content: [
    "./app/**/*.{ts,tsx}",
  ...
  theme: {
    extend: {
      colors: {
        // Surface scale (deepest → lightest)
        ink: "#030303", // hero / footer base
        surface: {
          DEFAULT: "#131315", // section background
          50: "#1e1e22",
          100: "#18181b",
          200: "#1e1e22",
          300: "#27272a",
        ...
        confirm: "#10b981", // emerald — confirmed / benign / executed
        refute: "#ef4444",
      },
      fontFamily: {
