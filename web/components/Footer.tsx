  ...
  return (
    <footer className="bg-[#030303] z-20 border-[#27272a]/50 border-t pt-20 pr-6 pb-10 pl-6 relative">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-16 md:gap-8">
        ...
        <div className="flex gap-16 sm:gap-24 flex-wrap">
          <div className="flex flex-col gap-4">
            <h4 className="text-white font-medium text-sm tracking-wide font-geist">Explore</h4>
            <ul className="flex flex-col gap-3">
              <li>
                <a className="text-zinc-500 hover:text-white text-sm font-extralight transition-colors font-geist" href="/dashboard">Dashboard</a>
              </li>
              <li>
                <a className="text-zinc-500 hover:text-white text-sm font-extralight transition-colors font-geist" href="#how-it-works">How it works</a>
              </li>
              <li>
                <a className="text-zinc-500 hover:text-white text-sm font-extralight transition-colors font-geist" href="#features">Capabilities</a>
              </li>
              <li>
                <a className="text-zinc-500 hover:text-white text-sm font-extralight transition-colors font-geist" href="#evaluation">Evaluation</a>
              </li>
            </ul>
          </div>
          <div className="flex flex-col gap-4">
            <h4 className="text-white font-medium text-sm tracking-wide font-geist">The stack</h4>
            <ul className="flex flex-col gap-3">
              <li>
                <a className="text-zinc-500 hover:text-white text-sm font-extralight transition-colors font-geist" href="https://splunkbase.splunk.com/app/7931" target="_blank" rel="noreferrer">Splunk MCP Server</a>
              </li>
              <li>
                <a className="text-zinc-500 hover:text-white text-sm font-extralight transition-colors font-geist" href="https://attack.mitre.org" target="_blank" rel="noreferrer">MITRE ATT&amp;CK</a>
              </li>
              <li>
                <a className="text-zinc-500 hover:text-white text-sm font-extralight transition-colors font-geist" href="https://www.anthropic.com" target="_blank" rel="noreferrer">Anthropic API</a>
              </li>
              <li>
                <a className="text-zinc-500 hover:text-white text-sm font-extralight transition-colors font-geist" href="https://aws.amazon.com/bedrock/" target="_blank" rel="noreferrer">AWS Bedrock</a>
              </li>
            </ul>
          </div>
          <div className="flex flex-col gap-4">
            <h4 className="text-white font-medium text-sm tracking-wide font-geist">Project</h4>
            <ul className="flex flex-col gap-3">
              <li>
                <a className="text-zinc-500 hover:text-white text-sm font-extralight transition-colors font-geist" href="https://github.com" target="_blank" rel="noreferrer">GitHub repo</a>
              </li>
              <li>
                <a className="text-zinc-500 hover:text-white text-sm font-extralight transition-colors font-geist" href="#evaluation">Benchmark &amp; results</a>
              </li>
              <li>
                <a className="text-zinc-500 hover:text-white text-sm font-extralight transition-colors font-geist" href="#features">What it does</a>
              </li>
              <li>
                <a className="text-zinc-500 hover:text-white text-sm font-extralight transition-colors font-geist" href="/dashboard">Live demo</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-[#27272a]/50 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-zinc-600 text-xs font-geist">© 2026 Argus · Built for the Splunk Agentic Ops Hackathon</p>
        <div className="flex items-center gap-2 text-zinc-600 text-xs font-geist">
          <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
          Security track · BOTS v3
        </div>
      </div>
    </footer>
  );
